 ...
 */
export function emojiProps(code: number) {
...
function nextZwj(sequence: number[], idx: number) {
 ...
 */
export function isEmojiZwjSequence(sequence: number[]) {
    ...
    let [cp1, cp2] = seq as [number, ...number[]],
 ...
 */
export function isEmojiModifierSequence(cp1: number, cp2: number) {
